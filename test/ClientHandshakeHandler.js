        ...
        describe("DTLS v" + v, function () {
            ...
            describe("send_clientHello", function () {
                it("should send ClientHello", function (done) {
                    ...
                    handshakeHandler.onSend = function (msgs) {
                        ...
                        msg.msgType.should.equal(
                            dtls.HandshakeType.clientHello
                        );
                ...
                it("should create new SecurityParameter", function () {
                    ...
                    parameters.pending.epoch.should.equal(
            ...
            describe("#handle_serverHello()", function () {
                it("should set the parameters", function () {
                    ...
                    var param = (handshakeHandler.newParameters = parameters.initNew(
                        version
                    ));
            ...
            describe("#handle_certificate()", function () {
                it("should store certificate", function () {
                    ...
                    var certificateList = [crypto.pseudoRandomBytes(1024)];
                    ...
                    // for HelloDone.
                    should.not.exist(action);
                    handshakeHandler.certificate.should.deep.equal(
                        certificateList[0]
                    );
                });
            });
            ...
            describe("#send_keyExchange()", function () {
                it("should send key", function (done) {
                    ...
                    handshakeHandler.onSend = function (msgs) {
                        ...
                        msgs[1].type.should.equal(
                            dtls.MessageType.changeCipherSpec
                        );
                        ...
                        const pem = parsePrivate("test/assets/certificate.pem");

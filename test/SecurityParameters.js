...
describe("SecurityParameters", function() {
    describe("#ctor()", function() {
        it("should initialize the object", function() {
            ...
            sp.sendSequence.current.should.deep.equal(
    ...
    describe("DTLS 1.2", function() {
        ...
        describe("#init()", function() {
            it("should calculate key material correctly", function() {
                ...
                var expected = {
                    cwmk: new Buffer(
                        "c83a7b69c782891a61ddc9306f35bc37a25f69db",
                        "hex"
                    ),
                    swmk: new Buffer(
                        "4e7321133d2a6af97851feebb97f373d4098169c",
                        "hex"
                    ),
    ...
    describe("AES_128_CBC cipher", function() {
        ...
        describe("#getCipher()", function() {
            it("should return working server-write aes-128-cbc cipher", function() {
                ...
                sp.clientWriteKey = new Buffer(
                    "373f963f4a2fbc13ffa22b256c46d36a",
                    "hex"
                );
                sp.serverWriteKey = new Buffer(
                    "41585768b95aa0fa9a18be07be5f1d3c",
                    "hex"
                );
                ...
                var data = new Buffer(
                    "48edcabd93af9026843f4326be93c81f" +
                        ...
                        "2651894e05695abdc42214170de48f09",
                    "hex"
                );
                ...
                var expected = new Buffer(
                    "477c287763301575026ef7b399e8d23c" +
                        ...
                        "be4a7ad5486fa08ec5e9ff30ba4507d5",
                    "hex"
                );
            ...
            it("should return working client-write aes-128-cbc cipher", function() {
                ...
                var expected = new Buffer(
                    "3ba3ad25235f5b5baa5467f556e71d96" +
                        ...
                        "e18ec5cce8db90a4b8d39c70d041c4a2",
                    "hex"
                );
        ...
        describe("#calculateIncomingMac()", function() {
            it("should calculate correct client-outgoing sha1 mac", function() {
                ...
                sp.serverWriteMacKey = new Buffer(
                    "4e7321133d2a6af97851feebb97f373d4098169c",
                    "hex"
                );
                ...
                var data = new Buffer(
                    "7804afb92904ad81ee5b046427c1a4dc" +
                        ...
                        "355295e4d1b7b4ccb700733cc3bc4958",
                    "hex"
                );

                var actual = sp.calculateIncomingMac(data);
                var expected = new Buffer(
                    "827451fec1fffae0c0f4955f1da9fe53f1b42c30",
                    "hex"
                );
            ...
            it("should calculate correct server-outgoing sha1 mac", function() {
                ...
                var actual = sp.calculateIncomingMac(data);
                var expected = new Buffer(
                    "ce9f001479227dbc11d60757bf94d113e9e7be9a",
                    "hex"
                );
            ...
            it("should perform TLS 1.2 digest on single data", function() {
                ...
                var expected = new Buffer(
                    "44ea752d8cd1c819007758528c81da75" +
                        "604feba1727222548221cea68db8c0d2",
                    "hex"
                );
